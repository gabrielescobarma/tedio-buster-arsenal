            ...
            <CardContent className="p-8">
              <div className="mb-8">
                ...
                <div className="flex justify-center mb-6">
                  <img src="/lovable-uploads/d158e8ad-5649-406d-aa57-de20048736e2.png" alt="Gatinho com quebra-cabeças" className="w-48 h-48 object-contain" />
                </div>
              ...
              <Button onClick={handleStartQuiz} size="lg" className="w-full py-4 text-xl font-bold bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 transform hover:scale-105 transition-all duration-200 shadow-lg"> COMEÇAR DIAGNÓSTICO GRATUITO</Button>
